    ...
    try {
      ...
      const out = lines.map((l) => {
        if (new RegExp("^a=fmtp:" + pt + " ").test(l)) {
          ...
          // v15: 128 kbps, stereo, DTX off, constant bitrate, NS+AGC+highpass off
          return l + ";stereo=1;sprop-stereo=1;maxaveragebitrate=128000;usedtx=0;cbr=1" +
                 ";googNoiseSuppression=0;googAutoGainControl=0;googHighpassFilter=0";
        }
        return l;
      });
...
if (!isOpen()) {
  ...
  function ensureUi() {
    ...
    ui.quickTitle = document.querySelector("#wt-now-label");

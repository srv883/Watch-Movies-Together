...
const SRC_PATH = "C:/Users/Sourav/Downloads/watch-together-v7/content.js";
...
async function main() {
  ...
  const MF = JSON.parse(fs.readFileSync("C:/Users/Sourav/Downloads/watch-together-v7/manifest.json", "utf8"));
  ok(MF.content_scripts[0].matches.indexOf("<all_urls>") !== -1, "content script runs on ALL sites (<all_urls>)");
  const POP = fs.readFileSync("C:/Users/Sourav/Downloads/watch-together-v7/popup.js", "utf8");
...
main().catch(e => { const s = "HARNESS CRASH: " + (e && e.stack || e); try { fs.writeFileSync("C:/Users/Sourav/Downloads/watch-together-tests/crash.txt", s); } catch (_) {} try { fs.writeFileSync("C:/Users/Sourav/Downloads/watch-together-tests/crash.txt", s); } catch (_) {} process.exitCode = 2; });

...
const SRC_PATH = "C:/Users/Sourav/ML Coding/watch-together-versions/V9-voice-fix/content.js";
...
async function main() {
  ...
  const MF = JSON.parse(fs.readFileSync("C:/Users/Sourav/ML Coding/watch-together-versions/V9-voice-fix/manifest.json", "utf8"));
  ok(MF.content_scripts[0].matches.indexOf("<all_urls>") !== -1, "content script runs on ALL sites (<all_urls>)");
  const POP = fs.readFileSync("C:/Users/Sourav/ML Coding/watch-together-versions/V9-voice-fix/popup.js", "utf8");

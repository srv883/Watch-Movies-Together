/* ============================================================
   V18 behaviour test harness (port of test-V17 + v18 additions)
   Runs the REAL V18-fullscreen/content.js twice (host+guest)
   against stubbed DOM / PeerJS / chrome APIs. New for v18:
     - voice fix: mono Opus encoding (stereo=0), no CBR, 96kbps
     - fullscreen: floating elements reparented into fullscreen container
     - liquid glass emoji bar (transparent, expand on hover)
     - removed "what's playing" label from emoji bar
   Run:  node tests/test-V18.js
   ============================================================ */
"use strict";
...
const SRC_PATH = "C:/Users/Sourav/ML Coding/watch-together-versions/V18-fullscreen/content.js";
const DIR12 = "C:/Users/Sourav/ML Coding/watch-together-versions/V18-fullscreen";
...
console.log("\n--- 12. error sweep ---");
  ...
  ok(!!QT.q("#wt-qtype-input"), "quick-type input exists");
  ...
  ok(QT.q("#wt-qtype-input").value === "", "input starts empty");
  ...
  QT.q("#wt-qtype-input").value = "quick hello from qtype";
  ...
  QT.q("#wt-qtype-input").value = "";
  QT.doc.dispatchDoc("keydown", { key: "t", target: QT.q("#wt-qtype-input") });
  await step(clock, 20);
  ...
  main().catch(e => { const s = "HARNESS CRASH: " + (e && e.stack || e); try { fs.writeFileSync("C:/Users/Sourav/ML Coding/watch-together-versions/tests/crash17.txt", s); } catch (_) {} process.exitCode = 2; });

/* ============================================================
   V22 behaviour test harness (port of test-V21 + v22 denoise)
   Runs the REAL V22-denoise/content.js twice (host+guest)
   against stubbed DOM / PeerJS / chrome APIs. v22 changes:
     - Chrome native noiseSuppression follows NC toggle (default ON)
     - NC toggle applies NS to LIVE track via applyConstraints
     - kills background-noise passthrough on the wire
   Run:  node tests/test-V22.js
   ============================================================ */
"use strict";
...
const SRC_PATH = "C:/Users/Sourav/ML Coding/watch-together-versions/V22-denoise/content.js";
const DIR12 = "C:/Users/Sourav/ML Coding/watch-together-versions/V22-denoise";
...
console.log("\n--- 12e. error sweep ---");
  ...
  ok(env.lastGum && env.lastGum.audio && env.lastGum.audio.noiseSuppression === true,
    "mic acquired with noiseSuppression=true (v22 default denoise ON)");
  ncBtn.click();
  await step(clock, 60);
  ...
  ok(env.lastGum && env.lastGum.audio && env.lastGum.audio.channelCount === 1 &&
     ...
     env.lastGum.audio.noiseSuppression === true && env.lastGum.audio.autoGainControl === false,
    "mic constraints: mono + EC/AGC OFF, NS ON by default (" + JSON.stringify(env.lastGum && env.lastGum.audio) + ")");

/* ============================================================
   ...
   Runs the REAL V11-hist-voice/content.js twice (host+guest)
...
const SRC_PATH = "C:/Users/Sourav/ML Coding/watch-together-versions/V11-hist-voice/content.js";
const DIR11 = "C:/Users/Sourav/ML Coding/watch-together-versions/V11-hist-voice";
...
async function main() {
  ...
  const MF = JSON.parse(fs.readFileSync(DIR11 + "/manifest.json", "utf8"));
  ok(MF.content_scripts[0].matches.indexOf("<all_urls>") !== -1, "content script runs on ALL sites (<all_urls>)");
  const POP = fs.readFileSync(DIR11 + "/popup.js", "utf8");
...
console.log("\n--- 12. error sweep ---");
  ...
  for (let i = 0; i < 12; i++) await step(clock, 120); // > hold window
  ...
  main().catch(e => { const s = "HARNESS CRASH: " + (e && e.stack || e); try { fs.writeFileSync("C:/Users/Sourav/ML Coding/watch-together-versions/tests/crash11.txt", s); } catch (_) {} process.exitCode = 2; });

...
const SRC_PATH = "C:/Users/Sourav/ML Coding/watch-together-versions/V8-liquid-glass/content.js";
...
async function main() {
  ...
  const MF = JSON.parse(fs.readFileSync("C:/Users/Sourav/ML Coding/watch-together-versions/V8-liquid-glass/manifest.json", "utf8"));
  ok(MF.content_scripts[0].matches.indexOf("<all_urls>") !== -1, "content script runs on ALL sites (<all_urls>)");
  const POP = fs.readFileSync("C:/Users/Sourav/ML Coding/watch-together-versions/V8-liquid-glass/popup.js", "utf8");
...
main().catch(e => { const s = "HARNESS CRASH: " + (e && e.stack || e); try { fs.writeFileSync("C:/Users/Sourav/ML Coding/watch-together-versions/tests/crash8.txt", s); } catch (_) {} process.exitCode = 2; });
